...
use Coopxl\LaravelMysqlSpatial\Exceptions\UnknownSpatialFunctionException;
use Coopxl\LaravelMysqlSpatial\Exceptions\UnknownSpatialRelationFunction;
...
trait SpatialTrait
{
    ...
    protected $stRelations = [
        'within', 'crosses', 'contains', 'disjoint', 'equals', 'intersects', 'overlaps', 'touches',
    ];
