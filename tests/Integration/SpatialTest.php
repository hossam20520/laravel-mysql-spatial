...
use Coopxl\LaravelMysqlSpatial\Types\GeometryCollection;
use Coopxl\LaravelMysqlSpatial\Types\LineString;
use Coopxl\LaravelMysqlSpatial\Types\MultiPoint;
use Coopxl\LaravelMysqlSpatial\Types\MultiPolygon;
...
class SpatialTest extends IntegrationBaseTestCase
{
    ...
    public function testSpatialFieldsNotDefinedException()
    {
        ...
        $this->assertException(\Coopxl\LaravelMysqlSpatial\Exceptions\SpatialFieldsNotDefinedException::class);
    ...
    public function testOrderBySpatialWithUnknownFunction()
    {
        ...
        $this->assertException(\Coopxl\LaravelMysqlSpatial\Exceptions\UnknownSpatialFunctionException::class);
    ...
    //    $point = new Point(0, 0);
    //
    //    $linestring1 = \Coopxl\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(1 1, 2 2)");
    //    $linestring2 = \Coopxl\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(20 20, 24 24)");
    //    $linestring3 = \Coopxl\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(0 10, 10 10)");
    //
