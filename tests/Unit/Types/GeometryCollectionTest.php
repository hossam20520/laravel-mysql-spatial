...
use Coopxl\LaravelMysqlSpatial\Types\GeometryInterface;
...
class GeometryCollectionTest extends BaseTestCase
{
    ...
    public function testInvalidArgumentExceptionNotArrayGeometries()
    {
        $this->assertException(
            ...
            'Coopxl\LaravelMysqlSpatial\Types\GeometryCollection must be a collection of Coopxl\LaravelMysqlSpatial\Types\GeometryInterface'
        );
        $geometrycollection = new GeometryCollection([
            $this->getPoint(),
            1,
    ...
    {
        $this->assertException(
            \Coopxl\LaravelMysqlSpatial\Exceptions\InvalidGeoJsonException::class,
