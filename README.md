...
[![Build Status](https://img.shields.io/travis/coopxl/laravel-mysql-spatial.svg?style=flat-square)](https://travis-ci.org/coopxl/laravel-mysql-spatial)
[![Code Climate](https://img.shields.io/codeclimate/maintainability/coopxl/laravel-mysql-spatial.svg?style=flat-square)](https://codeclimate.com/github/coopxl/laravel-mysql-spatial/maintainability)
[![Code Climate](https://img.shields.io/codeclimate/c/coopxl/laravel-mysql-spatial.svg?style=flat-square&colorB=4BCA2A)](https://codeclimate.com/github/coopxl/laravel-mysql-spatial/test_coverage) [![Packagist](https://img.shields.io/packagist/v/coopxl/laravel-mysql-spatial.svg?style=flat-square)](https://packagist.org/packages/coopxl/laravel-mysql-spatial)
[![Packagist](https://img.shields.io/packagist/dt/coopxl/laravel-mysql-spatial.svg?style=flat-square)](https://packagist.org/packages/coopxl/laravel-mysql-spatial) [![StyleCI](https://github.styleci.io/repos/83766141/shield?branch=master)](https://github.styleci.io/repos/83766141) 
...
```sh
$ composer require coopxl/laravel-mysql-spatial:^4.0

# or for Laravel version < 8.0
$ composer require coopxl/laravel-mysql-spatial:^3.0
```

For MySQL 5.7:

```shell
$ composer require coopxl/laravel-mysql-spatial:^2.0
```

For MySQL 5.6 and 5.5:

```shell
$ composer require coopxl/laravel-mysql-spatial:^1.0
```
...
'providers' => [
   ...
   */
  Coopxl\LaravelMysqlSpatial\SpatialServiceProvider::class,
],
```
...
Then edit the migration you just created by adding at least one spatial data field. For Laravel versions prior to 5.5, you can use the Blueprint provided by this package (Coopxl\LaravelMysqlSpatial\Schema\Blueprint):
 ...
 * @property \Coopxl\LaravelMysqlSpatial\Types\Polygon $area
 */
...
```php
use Coopxl\LaravelMysqlSpatial\Types\Point;
use Coopxl\LaravelMysqlSpatial\Types\Polygon;
use Coopxl\LaravelMysqlSpatial\Types\LineString;
...
| Coopxl\LaravelMysqlSpatial\Types                             | OpenGIS Class                                                |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
...
In order for your Eloquent Model to handle the Geometry classes, it must use the `Coopxl\LaravelMysqlSpatial\Eloquent\SpatialTrait` trait and define a `protected` property `$spatialFields`  as an array of MySQL Spatial Data Type column names (example in [Quickstart](#user-content-create-a-model)).
...
For Laravel versions prior to 5.5, you can use the Blueprint provided with this package: `Coopxl\LaravelMysqlSpatial\Schema\Blueprint`.
